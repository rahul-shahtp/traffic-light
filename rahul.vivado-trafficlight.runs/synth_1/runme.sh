...
HD_PWD='/home/thanda/Documents/vivado/rahul.vivado-trafficlight/rahul.vivado-trafficlight.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log trafficlight_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source trafficlight_controller.tcl
